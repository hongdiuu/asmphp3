...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admin.users.dashBoard')}}">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="{{route('admin.users.dashBoard')}}">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('admin.users.listUsers')}}">Danh Sách Users</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('admin.category.listCategories')}}">Danh Sách Danh Mục</a>
                <a class="collapse-item" href="{{route('admin.product.listProducts')}}">Danh Sách Sản Phẩm</a>
